define('dummy/tests/adapters/application-offline.jscs-test', ['exports'], function (exports) {
  ...
  test('adapters/application-offline.js should pass jscs', function () {
    ok(false, 'adapters/application-offline.js should pass jscs.\nInvalid line break at adapters/application-offline.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/adapters/application.jscs-test', ['exports'], function (exports) {
  ...
  test('adapters/application.js should pass jscs', function () {
    ok(false, 'adapters/application.js should pass jscs.\nInvalid line break at adapters/application.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/app.jscs-test', ['exports'], function (exports) {
  ...
  test('app.js should pass jscs', function () {
    ok(false, 'app.js should pass jscs.\nInvalid line break at app.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import Resolver from \'./resolver\';\n     3 |import loadInitializers from \'ember-load-initializers\';');
  });
});
...
define('dummy/tests/components/flexberry-sitemap.jscs-test', ['exports'], function (exports) {
  'use strict';

  module('JSCS - components');
  test('components/flexberry-sitemap.js should pass jscs', function () {
    ok(true, 'components/flexberry-sitemap.js should pass jscs.');
  });
});
define('dummy/tests/components/flexberry-sitemap.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components/flexberry-sitemap.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
...
define('dummy/tests/controllers/api-test-map.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/api-test-map.js should pass jscs', function () {
    ok(false, 'controllers/api-test-map.js should pass jscs.\nInvalid line break at controllers/api-test-map.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/controllers/components-examples/flexberry-boundingbox/settings-example.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/components-examples/flexberry-boundingbox/settings-example.js should pass jscs', function () {
    ok(false, 'controllers/components-examples/flexberry-boundingbox/settings-example.js should pass jscs.\nInvalid line break at controllers/components-examples/flexberry-boundingbox/settings-example.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |\n     3 |export default Ember.Controller.extend({');
  });
});
...
define('dummy/tests/controllers/map/new.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/map/new.js should pass jscs', function () {
    ok(false, 'controllers/map/new.js should pass jscs.\nInvalid line break at controllers/map/new.js :\n     1 |export { default } from \'../map\';\n-----------------------------------------^\n     2 |');
  });
});
...
define('dummy/tests/controllers/maps.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/maps.js should pass jscs', function () {
    ok(false, 'controllers/maps.js should pass jscs.\nInvalid line break at controllers/maps.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/controllers/new-platform-flexberry-g-i-s-map-object-setting-e.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs', function () {
    ok(false, 'controllers/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs.\nInvalid line break at controllers/new-platform-flexberry-g-i-s-map-object-setting-e.js :\n     1 |import EditFormController from \'ember-flexberry/controllers/edit-form\';\n-------------------------------------------------------------------------------^\n     2 |\n     3 |export default EditFormController.extend({');
  });
});
...
define('dummy/tests/controllers/new-platform-flexberry-g-i-s-map-object-setting-e/new.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/new-platform-flexberry-g-i-s-map-object-setting-e/new.js should pass jscs', function () {
    ok(false, 'controllers/new-platform-flexberry-g-i-s-map-object-setting-e/new.js should pass jscs.\nInvalid line break at controllers/new-platform-flexberry-g-i-s-map-object-setting-e/new.js :\n     1 |import NewPlatformFlexberryGISMapObjectSettingEController from \'../new-platform-flexberry-g-i-s-map-object-setting-e\';\n------------------------------------------------------------------------------------------------------------------------------^\n     2 |\n     3 |var NewPlatformFlexberryGISMapObjectSettingENewController = NewPlatformFlexberryGISMapObjectSettingEController;');
  });
});
...
define('dummy/tests/controllers/new-platform-flexberry-g-i-s-map-object-setting-l.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs', function () {
    ok(false, 'controllers/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs.\nInvalid line break at controllers/new-platform-flexberry-g-i-s-map-object-setting-l.js :\n     1 |import ListFormController from \'ember-flexberry/controllers/list-form\';\n-------------------------------------------------------------------------------^\n     2 |\n     3 |export default ListFormController.extend({');
  });
});
...
define('dummy/tests/controllers/sitemap-node.jscs-test', ['exports'], function (exports) {
  ...
  test('controllers/sitemap-node.js should pass jscs', function () {
    ok(false, 'controllers/sitemap-node.js should pass jscs.\nInvalid line break at controllers/sitemap-node.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |\n     3 |/**');
  });
});
...
define('dummy/tests/helpers/to-safe-string.jscs-test', ['exports'], function (exports) {
  ...
  test('helpers/to-safe-string.js should pass jscs', function () {
    ok(false, 'helpers/to-safe-string.js should pass jscs.\nInvalid line break at helpers/to-safe-string.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |\n     3 |/**');
  });
});
...
define('dummy/tests/helpers/to-string.jscs-test', ['exports'], function (exports) {
  ...
  test('helpers/to-string.js should pass jscs', function () {
    ok(false, 'helpers/to-string.js should pass jscs.\nInvalid line break at helpers/to-string.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |\n     3 |/**');
  });
});
...
define('dummy/tests/initializers/flexberry-objectlistview.jscs-test', ['exports'], function (exports) {
  'use strict';

  module('JSCS - initializers');
  test('initializers/flexberry-objectlistview.js should pass jscs', function () {
    ok(true, 'initializers/flexberry-objectlistview.js should pass jscs.');
  });
});
define('dummy/tests/initializers/flexberry-objectlistview.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - initializers/flexberry-objectlistview.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'initializers/flexberry-objectlistview.js should pass jshint.');
  });
});
define('dummy/tests/initializers/olv-toolbar.jscs-test', ['exports'], function (exports) {
  'use strict';

  module('JSCS - initializers');
  test('initializers/olv-toolbar.js should pass jscs', function () {
    ok(true, 'initializers/olv-toolbar.js should pass jscs.');
  });
});
define('dummy/tests/initializers/olv-toolbar.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - initializers/olv-toolbar.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'initializers/olv-toolbar.js should pass jshint.');
  });
});
...
define('dummy/tests/integration/components/flexberry-dropdown-input-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-dropdown-input-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-dropdown-input-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-dropdown-input-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/flexberry-edit-crs-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-edit-crs-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-edit-crs-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-edit-crs-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'flexberry-edit-crs\', \'Integration | Component | flexberry edit crs\', {');
  });
});
...
define('dummy/tests/integration/components/flexberry-layers-intersections-panel-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-layers-intersections-panel-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-layers-intersections-panel-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-layers-intersections-panel-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |// import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/flexberry-layers-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-layers-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-layers-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-layers-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/flexberry-map-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-map-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-map-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-map-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/flexberry-maptoolbar-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-maptoolbar-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-maptoolbar-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-maptoolbar-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/flexberry-multiple-select-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-multiple-select-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-multiple-select-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-multiple-select-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/flexberry-search-panel-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-search-panel-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-search-panel-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-search-panel-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/flexberry-table-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-table-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-table-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-table-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/flexberry-wfs-filter-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/flexberry-wfs-filter-test.js should pass jscs', function () {
    ok(false, 'integration/components/flexberry-wfs-filter-test.js should pass jscs.\nInvalid line break at integration/components/flexberry-wfs-filter-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/geometry-add-modes/draw-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/geometry-add-modes/draw-test.js should pass jscs', function () {
    ok(false, 'integration/components/geometry-add-modes/draw-test.js should pass jscs.\nInvalid line break at integration/components/geometry-add-modes/draw-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |// import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/geometry-add-modes/geoprovider-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/geometry-add-modes/geoprovider-test.js should pass jscs', function () {
    ok(false, 'integration/components/geometry-add-modes/geoprovider-test.js should pass jscs.\nInvalid line break at integration/components/geometry-add-modes/geoprovider-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |// import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/geometry-add-modes/manual-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/geometry-add-modes/manual-test.js should pass jscs', function () {
    ok(false, 'integration/components/geometry-add-modes/manual-test.js should pass jscs.\nInvalid line break at integration/components/geometry-add-modes/manual-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |// import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/layers-dialogs/attributes/edit-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers-dialogs/attributes/edit-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers-dialogs/attributes/edit-test.js should pass jscs.\nInvalid line break at integration/components/layers-dialogs/attributes/edit-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/layers-dialogs/settings/combine-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers-dialogs/settings/combine-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers-dialogs/settings/combine-test.js should pass jscs.\nInvalid line break at integration/components/layers-dialogs/settings/combine-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/layers-dialogs/tabs/identification-settings-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers-dialogs/tabs/identification-settings-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers-dialogs/tabs/identification-settings-test.js should pass jscs.\nInvalid line break at integration/components/layers-dialogs/tabs/identification-settings-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/layers-dialogs/tabs/legend-settings-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers-dialogs/tabs/legend-settings-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers-dialogs/tabs/legend-settings-test.js should pass jscs.\nInvalid line break at integration/components/layers-dialogs/tabs/legend-settings-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/integration/components/layers/group-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers/group-layer-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers/group-layer-test.js should pass jscs.\nInvalid line break at integration/components/layers/group-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/layers/osm-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/layers/osm-layer-test.js should pass jscs', function () {
    ok(false, 'integration/components/layers/osm-layer-test.js should pass jscs.\nInvalid line break at integration/components/layers/osm-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/legends/wms-legend-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    var $images = this.$('img');
    var url = 'http://212.192.76.235:8080/geoserver/wms';
    var src = url + '?service=WMS&request=GetLegendGraphic&version=1.1.0&format=image%2Fpng&width=24&height=24&layer=lesonas1969%3Agoszem&style=';
...
define('dummy/tests/integration/components/minimap-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/minimap-control-test.js should pass jscs', function () {
    ok(false, 'integration/components/minimap-control-test.js should pass jscs.\nInvalid line break at integration/components/minimap-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import hbs from \'htmlbars-inline-precompile\';\n     3 |');
  });
});
...
define('dummy/tests/integration/components/spatial-bookmark-test.jscs-test', ['exports'], function (exports) {
  ...
  test('integration/components/spatial-bookmark-test.js should pass jscs', function () {
    ok(false, 'integration/components/spatial-bookmark-test.js should pass jscs.\nInvalid line break at integration/components/spatial-bookmark-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import hbs from \'htmlbars-inline-precompile\';');
  });
});
...
define('dummy/tests/locales/en/forms.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms.js should pass jscs', function () {
    ok(false, 'locales/en/forms.js should pass jscs.\nInvalid line break at locales/en/forms.js :\n     1 |import Index from \'./forms/index\';\n------------------------------------------^\n     2 |import Loading from \'./forms/loading\';\n     3 |import Application from \'./forms/application\';');
  });
});
...
define('dummy/tests/locales/en/forms/application.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/application.js should pass jscs', function () {
    ok(false, 'locales/en/forms/application.js should pass jscs.\nInvalid line break at locales/en/forms/application.js :\n     1 |import Header from \'./application/header\';\n--------------------------------------------------^\n     2 |import Footer from \'./application/footer\';\n     3 |import Sitemap from \'./application/sitemap\';');
  });
});
...
define('dummy/tests/locales/en/forms/application/footer.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/application/footer.js should pass jscs', function () {
    ok(false, 'locales/en/forms/application/footer.js should pass jscs.\nInvalid line break at locales/en/forms/application/footer.js :\n     1 |export default {\n------------------------^\n     2 |  \'application-name\': \'Test stand for ember-flexberry-gis\',\n     3 |  \'application-version\': {');
  });
});
...
define('dummy/tests/locales/en/forms/application/header.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/application/header.js should pass jscs', function () {
    ok(false, 'locales/en/forms/application/header.js should pass jscs.\nInvalid line break at locales/en/forms/application/header.js :\n     1 |export default {\n------------------------^\n     2 |  \'menu\': {\n     3 |    \'sitemap-button\': {');
  });
});
...
define('dummy/tests/locales/en/forms/application/sitemap.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/application/sitemap.js should pass jscs', function () {
    ok(false, 'locales/en/forms/application/sitemap.js should pass jscs.\nInvalid line break at locales/en/forms/application/sitemap.js :\n     1 |export default {\n------------------------^\n     2 |  \'application-name\': {\n     3 |    \'caption\': \'Test stand for ember-flexberry-gis\',');
  });
});
...
define('dummy/tests/locales/en/forms/components-examples.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/components-examples.js should pass jscs', function () {
    ok(false, 'locales/en/forms/components-examples.js should pass jscs.\nInvalid line break at locales/en/forms/components-examples.js :\n     1 |export default {\n------------------------^\n     2 |  \'flexberry-boundingbox\': {\n     3 |    \'settings-example\': {');
  });
});
...
define('dummy/tests/locales/en/forms/edit-form.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/edit-form.js should pass jscs', function () {
    ok(false, 'locales/en/forms/edit-form.js should pass jscs.\nInvalid line break at locales/en/forms/edit-form.js :\n     1 |export default {\n------------------------^\n     2 |  \'save-success-message-caption\': \'Save operation succeed\',\n     3 |  \'save-success-message\': \'Object saved\',');
  });
});
...
define('dummy/tests/locales/en/forms/index.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/index.js should pass jscs', function () {
    ok(false, 'locales/en/forms/index.js should pass jscs.\nInvalid line break at locales/en/forms/index.js :\n     1 |export default {\n------------------------^\n     2 |  \'greeting\': \'Welcome to ember-flexberry-gis test stand!\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/en/forms/loading.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/loading.js should pass jscs', function () {
    ok(false, 'locales/en/forms/loading.js should pass jscs.\nInvalid line break at locales/en/forms/loading.js :\n     1 |export default {\n------------------------^\n     2 |  \'spinner-caption\': \'Loading data, please wait...\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/en/forms/maps.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/maps.js should pass jscs', function () {
    ok(false, 'locales/en/forms/maps.js should pass jscs.\nInvalid line break at locales/en/forms/maps.js :\n     1 |export default {\n------------------------^\n     2 |  \'caption\': \'Maps\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-e.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs', function () {
    ok(false, 'locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs.\nInvalid line break at locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js :\n     1 |export default {\n------------------------^\n     2 |  caption: \'Map Object Setting\',\n     3 |  \'typeName-caption\': \'Type Name\',');
  });
});
...
define('dummy/tests/locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-l.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs', function () {
    ok(false, 'locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs.\nInvalid line break at locales/en/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js :\n     1 |export default {\n------------------------^\n     2 |  caption: \'Map Object Setting\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/en/translations.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/en/translations.js should pass jscs', function () {
    ok(false, 'locales/en/translations.js should pass jscs.\nInvalid line break at locales/en/translations.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import EmberFlexberryTranslations from \'ember-flexberry/locales/en/translations\';\n     3 |import EmberFlexberryGisTranslations from \'ember-flexberry-gis/locales/en/translations\';');
  });
});
...
define('dummy/tests/locales/ru/forms.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms.js should pass jscs', function () {
    ok(false, 'locales/ru/forms.js should pass jscs.\nInvalid line break at locales/ru/forms.js :\n     1 |import Index from \'./forms/index\';\n------------------------------------------^\n     2 |import Loading from \'./forms/loading\';\n     3 |import Application from \'./forms/application\';');
  });
});
...
define('dummy/tests/locales/ru/forms/application.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/application.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/application.js should pass jscs.\nInvalid line break at locales/ru/forms/application.js :\n     1 |import Header from \'./application/header\';\n--------------------------------------------------^\n     2 |import Footer from \'./application/footer\';\n     3 |import Sitemap from \'./application/sitemap\';');
  });
});
...
define('dummy/tests/locales/ru/forms/application/footer.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/application/footer.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/application/footer.js should pass jscs.\nInvalid line break at locales/ru/forms/application/footer.js :\n     1 |export default {\n------------------------^\n     2 |  \'application-name\': \'Тестовый стенд ember-flexberry-gis\',\n     3 |  \'application-version\': {');
  });
});
...
define('dummy/tests/locales/ru/forms/application/header.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/application/header.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/application/header.js should pass jscs.\nInvalid line break at locales/ru/forms/application/header.js :\n     1 |export default {\n------------------------^\n     2 |  \'menu\': {\n     3 |    \'sitemap-button\': {');
  });
});
...
define('dummy/tests/locales/ru/forms/application/sitemap.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/application/sitemap.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/application/sitemap.js should pass jscs.\nInvalid line break at locales/ru/forms/application/sitemap.js :\n     1 |export default {\n------------------------^\n     2 |  \'application-name\': {\n     3 |    \'caption\': \'Тестовый стенд ember-flexberry-gis\',');
  });
});
...
define('dummy/tests/locales/ru/forms/components-examples.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/components-examples.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/components-examples.js should pass jscs.\nInvalid line break at locales/ru/forms/components-examples.js :\n     1 |export default {\n------------------------^\n     2 |  \'flexberry-boundingbox\': {\n     3 |    \'settings-example\': {');
  });
});
...
define('dummy/tests/locales/ru/forms/edit-form.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/edit-form.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/edit-form.js should pass jscs.\nInvalid line break at locales/ru/forms/edit-form.js :\n     1 |export default {\n------------------------^\n     2 |  \'save-success-message-caption\': \'Сохранение завершилось успешно\',\n     3 |  \'save-success-message\': \'Объект сохранен\',');
  });
});
...
define('dummy/tests/locales/ru/forms/index.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/index.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/index.js should pass jscs.\nInvalid line break at locales/ru/forms/index.js :\n     1 |export default {\n------------------------^\n     2 |  \'greeting\': \'Добро пожаловать на тестовый стенд ember-flexberry-gis!\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/ru/forms/loading.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/loading.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/loading.js should pass jscs.\nInvalid line break at locales/ru/forms/loading.js :\n     1 |export default {\n------------------------^\n     2 |  \'spinner-caption\': \'Данные загружаются, пожалуйста подождите...\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/ru/forms/maps.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/maps.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/maps.js should pass jscs.\nInvalid line break at locales/ru/forms/maps.js :\n     1 |export default {\n------------------------^\n     2 |  \'caption\': \'Карты\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-e.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs.\nInvalid line break at locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-e.js :\n     1 |export default {\n------------------------^\n     2 |  caption: \'Настройка объектов карты\',\n     3 |  \'typeName-caption\': \'Тип\',');
  });
});
...
define('dummy/tests/locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-l.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs', function () {
    ok(false, 'locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js should pass jscs.\nInvalid line break at locales/ru/forms/new-platform-flexberry-g-i-s-map-object-setting-l.js :\n     1 |export default {\n------------------------^\n     2 |  caption: \'Настройка объектов карты\'\n     3 |};');
  });
});
...
define('dummy/tests/locales/ru/translations.jscs-test', ['exports'], function (exports) {
  ...
  test('locales/ru/translations.js should pass jscs', function () {
    ok(false, 'locales/ru/translations.js should pass jscs.\nInvalid line break at locales/ru/translations.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import EmberFlexberryTranslations from \'ember-flexberry/locales/ru/translations\';\n     3 |import EmberFlexberryGisTranslations from \'ember-flexberry-gis/locales/ru/translations\';');
  });
});
...
define('dummy/tests/models/components-examples/flexberry-ddau-checkbox/settings-example/base.jscs-test', ['exports'], function (exports) {
  ...
  test('models/components-examples/flexberry-ddau-checkbox/settings-example/base.js should pass jscs', function () {
    ok(false, 'models/components-examples/flexberry-ddau-checkbox/settings-example/base.js should pass jscs.\nInvalid line break at models/components-examples/flexberry-ddau-checkbox/settings-example/base.js :\n     1 |import DS from \'ember-data\';\n------------------------------------^\n     2 |import { Projection } from \'ember-flexberry-data\';\n     3 |');
  });
});
...
define('dummy/tests/models/custom-inflector-rules.jscs-test', ['exports'], function (exports) {
  ...
  test('models/custom-inflector-rules.js should pass jscs', function () {
    ok(false, 'models/custom-inflector-rules.js should pass jscs.\nInvalid line break at models/custom-inflector-rules.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/resolver.jscs-test', ['exports'], function (exports) {
  ...
  test('resolver.js should pass jscs', function () {
    ok(false, 'resolver.js should pass jscs.\nInvalid line break at resolver.js :\n     1 |export { default } from \'ember-flexberry/resolver\';\n-----------------------------------------------------------^\n     2 |');
  });
});
...
define('dummy/tests/routes/api-test-map.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/api-test-map.js should pass jscs', function () {
    ok(false, 'routes/api-test-map.js should pass jscs.\nInvalid line break at routes/api-test-map.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/routes/application.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/application.js should pass jscs', function () {
    ok(false, 'routes/application.js should pass jscs.\nInvalid line break at routes/application.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/routes/components-examples/flexberry-boundingbox/settings-example.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/components-examples/flexberry-boundingbox/settings-example.js should pass jscs', function () {
    ok(false, 'routes/components-examples/flexberry-boundingbox/settings-example.js should pass jscs.\nInvalid line break at routes/components-examples/flexberry-boundingbox/settings-example.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import generateUniqueId from \'ember-flexberry-data/utils/generate-unique-id\';\n     3 |');
  });
});
...
define('dummy/tests/routes/index.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/index.js should pass jscs', function () {
    ok(false, 'routes/index.js should pass jscs.\nInvalid line break at routes/index.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/routes/maps.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/maps.js should pass jscs', function () {
    ok(false, 'routes/maps.js should pass jscs.\nInvalid line break at routes/maps.js :\n     1 |/**\n-----------^\n     2 |  @module ember-flexberry-gis-dummy\n     3 |*/');
  });
});
...
define('dummy/tests/routes/new-platform-flexberry-g-i-s-map-object-setting-e.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs', function () {
    ok(false, 'routes/new-platform-flexberry-g-i-s-map-object-setting-e.js should pass jscs.\nInvalid line break at routes/new-platform-flexberry-g-i-s-map-object-setting-e.js :\n     1 |import EditFormRoute from \'ember-flexberry/routes/edit-form\';\n---------------------------------------------------------------------^\n     2 |\n     3 |export default EditFormRoute.extend({');
  });
});
...
define('dummy/tests/routes/new-platform-flexberry-g-i-s-map-object-setting-e/new.jscs-test', ['exports'], function (exports) {
  ...
  test('routes/new-platform-flexberry-g-i-s-map-object-setting-e/new.js should pass jscs', function () {
    ok(false, 'routes/new-platform-flexberry-g-i-s-map-object-setting-e/new.js should pass jscs.\nInvalid line break at routes/new-platform-flexberry-g-i-s-map-object-setting-e/new.js :\n     1 |import EditFormNewRoute from \'ember-flexberry/routes/edit-form-new\';\n----------------------------------------------------------------------------^\n     2 |\n     3 |export default EditFormNewRoute.extend({');
  });
});
...
define('dummy/tests/unit/components/base-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/base-control-test.js should pass jscs', function () {
    ok(false, 'unit/components/base-control-test.js should pass jscs.\nInvalid line break at unit/components/base-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import sinon from \'sinon\';\n     3 |');
  });
});
...
define('dummy/tests/unit/components/base-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/base-layer-test.js should pass jscs', function () {
    ok(false, 'unit/components/base-layer-test.js should pass jscs.\nInvalid line break at unit/components/base-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import sinon from \'sinon\';\n     3 |');
  });
});
    ...
    _ember['default'].run(function () {
      ...
      var component = _this8.subject({
        createVectorLayer: function createVectorLayer() {
          ...
          layer.options = options;
          feature.addTo(leafletMap);
          var label = L.marker([50.5, 30.5]);
          var _labelsLayer = L.featureGroup([label]);
          layer._labelsLayer = _labelsLayer;
          _labelsLayer.addTo(leafletMap);
...
define('dummy/tests/unit/components/compare-object-geometries-panel-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/compare-object-geometries-panel-test.js should pass jscs', function () {
    ok(false, 'unit/components/compare-object-geometries-panel-test.js should pass jscs.\nInvalid line break at unit/components/compare-object-geometries-panel-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import sinon from \'sinon\';\n     3 |');
  });
});
...
define('dummy/tests/unit/components/flexberry-layers-attributes-panel-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/flexberry-layers-attributes-panel-test.js should pass jscs', function () {
    ok(false, 'unit/components/flexberry-layers-attributes-panel-test.js should pass jscs.\nInvalid line break at unit/components/flexberry-layers-attributes-panel-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import Ember from \'ember\';\n     3 |');
  });
});
...
define('dummy/tests/unit/components/flexberry-map-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/flexberry-map-test.js should pass jscs', function () {
    ok(false, 'unit/components/flexberry-map-test.js should pass jscs.\nInvalid line break at unit/components/flexberry-map-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import sinon from \'sinon\';');
  });
});
...
define('dummy/tests/unit/components/layers/combine-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/layers/combine-layer-test.js should pass jscs', function () {
    ok(false, 'unit/components/layers/combine-layer-test.js should pass jscs.\nInvalid line break at unit/components/layers/combine-layer-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { moduleForComponent, test } from \'ember-qunit\';\n     3 |import startApp from \'dummy/tests/helpers/start-app\';');
  });
});
...
define('dummy/tests/unit/components/layers/group-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/layers/group-layer-test.js should pass jscs', function () {
    ok(false, 'unit/components/layers/group-layer-test.js should pass jscs.\nInvalid line break at unit/components/layers/group-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import sinon from \'sinon\';\n     3 |');
  });
});
...
define('dummy/tests/unit/components/layers/tile-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/layers/tile-layer-test.js should pass jscs', function () {
    ok(false, 'unit/components/layers/tile-layer-test.js should pass jscs.\nInvalid line break at unit/components/layers/tile-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'layers/tile-layer\', \'Unit | Component | layers/tile layer\', {');
  });
});
  ...
  (0, _emberQunit.test)('loadLayerFeatures() with options showExisting = false', function (assert) {
    ...
    _ember['default'].run(function () {
      ...
      L.wfst(options, component.getFeaturesReadFormat()).once('load', function (res) {
        ...
        component._leafletObject.loadFeatures = function () {
...
define('dummy/tests/unit/components/layers/with-history-layer-test', ['exports', 'ember', 'ember-data', 'ember-qunit', 'dummy/tests/helpers/start-app', 'ember-flexberry-data', 'sinon', 'dummy/tests/helpers/common-for-layer'], function (exports, _ember, _emberData, _emberQunit, _dummyTestsHelpersStartApp, _emberFlexberryData, _sinon, _dummyTestsHelpersCommonForLayer) {
  ...
  var app = undefined;
  var geoserverFake = undefined;
  var optionsWFS = undefined;
  var paramWFS = undefined;
  var optionsOdata = undefined;
  var paramOdata = undefined;
  var store = undefined;

  (0, _emberQunit.moduleForComponent)('layers/with-history-layer', 'Unit | Component | layers/with history layer', {
    unit: true,
    needs: ['service:map-api', 'config:environment', 'component:base-vector-layer', 'service:layers-styles-renderer', 'model:new-platform-flexberry-g-i-s-link-parameter', 'model:new-platform-flexberry-g-i-s-map', 'model:new-platform-flexberry-g-i-s-map-layer', 'adapter:application', 'layer:odata-vector', 'component:layers/odata-vector-layer', 'component:layers/wfs-layer'],
    beforeEach: function beforeEach() {
      app = (0, _dummyTestsHelpersStartApp['default'])();
      store = app.__container__.lookup('service:store');
      ...
      var timetestModel = _emberFlexberryData.Projection.Model.extend(testModelMixin);
      ...
      app.register('mixin:test-model', testModelMixin);
      app.register('serializer:test-model', testSerializer);
      var layerModelWfs = store.createRecord('test-model');
      ...
      var leafletOptions = ['url', 'version', 'namespaceUri', 'typeNS', 'geometryField', 'typeName', 'typeNSName', 'crs', 'maxFeatures', 'showExisting', 'style', 'filter', 'forceMulti', 'withCredentials', 'continueLoading'];
      ...
      geoserverFake.respondWith('POST', 'http://geoserverFake/geoserver/les_history/ows?', function (request) {
        if (request.requestBody === '<wfs:GetFeature xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="1.1.0" outputFormat="application/json">' + '<wfs:Query typeName="les:povorottochkipoint32640" srsName="EPSG:3857"><ogc:Filter xmlns:ogc="http://www.opengis.net/ogc"><Not><Or>' + '<ogc:PropertyIsEqualTo matchCase="false"><ogc:PropertyName>primarykey</ogc:PropertyName><ogc:Literal>475adc5b-fee4-4e8c-bed0-93746a9f00f0' + '</ogc:Literal></ogc:PropertyIsEqualTo></Or></Not></ogc:Filter></wfs:Query></wfs:GetFeature>') {
          request.respond(200, { 'Content-Type': 'application/json' }, '{"type":"FeatureCollection","features":[],"totalFeatures":0,"numberMatched":0,"numberReturned":0,"timeStamp":"2020-02-27T04:44:49.909Z",' + '"crs":null}');
        }
      ...
      paramOdata = _ember['default'].$.extend(paramOdata, optionsOdata);
      var layerModelOdata = store.createRecord('test-model');
      layerModelOdata.type = 'odata-vector';
      layerModelOdata.settingsAsObject = optionsOdata;
      _ember['default'].$.extend(paramOdata, {
        'geometryType': 'MultiPolygonPropertyType',
        'modelName': 'test-model',
        'projectionName': 'TestModelL',
        'geometryField': 'shape',
  ...
  (0, _emberQunit.test)('it return L.WFS on createLayer', function (assert) {
    var component = this.subject(paramWFS);
    var done = assert.async(1);

    component.get('_leafletLayerPromise').then(function () {
  ...
  (0, _emberQunit.test)('it return Odata on createLayer', function (assert) {
    var component = this.subject(paramOdata);
    var done = assert.async(1);
...
define('dummy/tests/unit/components/layers/with-history-layer-test.jscs-test', ['exports'], function (exports) {
  'use strict';

  module('JSCS - unit/components/layers');
  test('unit/components/layers/with-history-layer-test.js should pass jscs', function () {
    ok(true, 'unit/components/layers/with-history-layer-test.js should pass jscs.');
  });
});
define('dummy/tests/unit/components/layers/with-history-layer-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/components/layers/with-history-layer-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/components/layers/with-history-layer-test.js should pass jshint.');
  });
});
...
define('dummy/tests/unit/components/layers/wms-layer-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/layers/wms-layer-test.js should pass jscs', function () {
    ok(false, 'unit/components/layers/wms-layer-test.js should pass jscs.\nInvalid line break at unit/components/layers/wms-layer-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'layers/wms-layer\', \'Unit | Component | layers/wms layer\', {');
  });
});
...
define('dummy/tests/unit/components/minimap-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/minimap-control-test.js should pass jscs', function () {
    ok(false, 'unit/components/minimap-control-test.js should pass jscs.\nInvalid line break at unit/components/minimap-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'minimap-control\', \'Unit | Component | minimap control\', {');
  });
});
...
define('dummy/tests/unit/components/scale-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/scale-control-test.js should pass jscs', function () {
    ok(false, 'unit/components/scale-control-test.js should pass jscs.\nInvalid line break at unit/components/scale-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'scale-control\', \'Unit | Component | scale control\', {');
  });
});
...
define('dummy/tests/unit/components/switch-scale-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/switch-scale-control-test.js should pass jscs', function () {
    ok(false, 'unit/components/switch-scale-control-test.js should pass jscs.\nInvalid line break at unit/components/switch-scale-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |import sinon from \'sinon\';\n     3 |');
  });
});
...
define('dummy/tests/unit/components/zoomslider-control-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/components/zoomslider-control-test.js should pass jscs', function () {
    ok(false, 'unit/components/zoomslider-control-test.js should pass jscs.\nInvalid line break at unit/components/zoomslider-control-test.js :\n     1 |import { moduleForComponent, test } from \'ember-qunit\';\n---------------------------------------------------------------^\n     2 |\n     3 |moduleForComponent(\'zoomslider-control\', \'Unit | Component | zoomslider control\', {');
  });
});
...
define('dummy/tests/unit/controllers/edit-map-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/controllers/edit-map-test.js should pass jscs', function () {
    ok(false, 'unit/controllers/edit-map-test.js should pass jscs.\nInvalid line break at unit/controllers/edit-map-test.js :\n     1 |import EditMapController from \'ember-flexberry-gis/controllers/edit-map\';\n---------------------------------------------------------------------------------^\n     2 |import { module, test } from \'qunit\';\n     3 |');
  });
});
...
define('dummy/tests/unit/controllers/gis-search-form-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/controllers/gis-search-form-test.js should pass jscs', function () {
    ok(false, 'unit/controllers/gis-search-form-test.js should pass jscs.\nInvalid line break at unit/controllers/gis-search-form-test.js :\n     1 |import { moduleFor, test } from \'ember-qunit\';\n------------------------------------------------------^\n     2 |\n     3 |moduleFor(\'controller:gis-search-form\', \'Unit | Controller | gis search form\', {');
  });
});
...
define('dummy/tests/unit/controllers/list-map-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/controllers/list-map-test.js should pass jscs', function () {
    ok(false, 'unit/controllers/list-map-test.js should pass jscs.\nInvalid line break at unit/controllers/list-map-test.js :\n     1 |import ListMapController from \'ember-flexberry-gis/controllers/list-map\';\n---------------------------------------------------------------------------------^\n     2 |import { module, test } from \'qunit\';\n     3 |');
  });
});
...
define('dummy/tests/unit/helpers/flexberry-search-properties-osm-ru-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/helpers/flexberry-search-properties-osm-ru-test.js should pass jscs', function () {
    ok(false, 'unit/helpers/flexberry-search-properties-osm-ru-test.js should pass jscs.\nInvalid line break at unit/helpers/flexberry-search-properties-osm-ru-test.js :\n     1 |import { flexberrySearchPropertiesOsmRu } from \'dummy/helpers/flexberry-search-properties-osm-ru\';\n----------------------------------------------------------------------------------------------------------^\n     2 |import { module, test } from \'qunit\';\n     3 |');
  });
});
...
define('dummy/tests/unit/helpers/instance-of-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/helpers/instance-of-test.js should pass jscs', function () {
    ok(false, 'unit/helpers/instance-of-test.js should pass jscs.\nInvalid line break at unit/helpers/instance-of-test.js :\n     1 |import { instanceOf } from \'dummy/helpers/instance-of\';\n---------------------------------------------------------------^\n     2 |import { module, test } from \'qunit\';\n     3 |');
  });
});
...
define('dummy/tests/unit/initializers/flexberry-map-commands-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/initializers/flexberry-map-commands-test.js should pass jscs', function () {
    ok(false, 'unit/initializers/flexberry-map-commands-test.js should pass jscs.\nInvalid line break at unit/initializers/flexberry-map-commands-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import FlexberryMapCommandsInitializer from \'dummy/initializers/map-commands\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/initializers/flexberry-map-tools-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/initializers/flexberry-map-tools-test.js should pass jscs', function () {
    ok(false, 'unit/initializers/flexberry-map-tools-test.js should pass jscs.\nInvalid line break at unit/initializers/flexberry-map-tools-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import FlexberryMapToolsInitializer from \'dummy/initializers/map-tools\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/initializers/local-storage-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/initializers/local-storage-test.js should pass jscs', function () {
    ok(false, 'unit/initializers/local-storage-test.js should pass jscs.\nInvalid line break at unit/initializers/local-storage-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import LocalStorageInitializer from \'ember-flexberry-gis/initializers/local-storage\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/instance-initializers/open-map-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/instance-initializers/open-map-test.js should pass jscs', function () {
    ok(false, 'unit/instance-initializers/open-map-test.js should pass jscs.\nInvalid line break at unit/instance-initializers/open-map-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import { initialize } from \'dummy/instance-initializers/open-map\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/mixins/dynamic-properties-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/mixins/dynamic-properties-test.js should pass jscs', function () {
    ok(false, 'unit/mixins/dynamic-properties-test.js should pass jscs.\nInvalid line break at unit/mixins/dynamic-properties-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import DynamicPropertiesMixin from \'ember-flexberry-gis/mixins/dynamic-properties\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/mixins/favorites-features-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/mixins/favorites-features-test.js should pass jscs', function () {
    ok(false, 'unit/mixins/favorites-features-test.js should pass jscs.\nInvalid line break at unit/mixins/favorites-features-test.js :\n     1 |import Ember from \'ember\';\n----------------------------------^\n     2 |import FavoriteFeature from \'ember-flexberry-gis/mixins/favorites-features\';\n     3 |import { module, test } from \'qunit\';');
  });
});
...
define('dummy/tests/unit/mixins/flexberry-map-model-api-copy-objects-test', ['exports', 'ember', 'qunit', 'ember-flexberry-gis/mixins/flexberry-map-model-api', 'sinon'], function (exports, _ember, _qunit, _emberFlexberryGisMixinsFlexberryMapModelApi, _sinon) {
  ...
  (0, _qunit.test)('test method copyObjects on small array (with properties and delete layer)', function (assert) {
    //Arrange
    assert.expect(12);
    var done = assert.async(1);
    var sourceLeafletLayer = L.featureGroup();
    smallPolygons.forEach(function (object) {
      sourceLeafletLayer.addLayer(object);
    });
    var _loadingFeaturesByPackages = function _loadingFeaturesByPackages() {
      return [_ember['default'].RSVP.resolve([{}, sourceLeafletLayer, []])];
    };

    var _getLayerFeatureId = function _getLayerFeatureId(model, object) {
      return object.id;
    };
    ...
    var loadingFBP = _sinon['default'].stub(subject, 'loadingFeaturesByPackages', _loadingFeaturesByPackages);
    var getMLObject = _sinon['default'].stub(subject, '_getModelLeafletObject');
    ...
    var getLFid = _sinon['default'].stub(subject, '_getLayerFeatureId', _getLayerFeatureId);

    //Act
    var result = subject.copyObjectsBatch({
      layerId: '1',
      objectIds: ['1'],
      shouldRemove: true
    }, {
  ...
  (0, _qunit.test)('test method copyObjects on small array (with properties)', function (assert) {
    //Arrange
    assert.expect(10);
    var done = assert.async(1);
    var sourceLeafletLayer = L.featureGroup();
  ...
  (0, _qunit.test)('test method copyObjects on big array (without properties and delete layers)', function (assert) {
    //Arrange
    assert.expect(12);
    var done = assert.async(1);
    var sourceLeafletLayer = L.featureGroup();
    bigPolygons.forEach(function (object) {
      sourceLeafletLayer.addLayer(object);
    });
    var _getLayerFeatureId = function _getLayerFeatureId(model, object) {
      return object.id;
  ...
  (0, _qunit.test)('test method copyObjects on big array (without properties)', function (assert) {
    //Arrange
    assert.expect(10);
    var done = assert.async(1);
    var sourceLeafletLayer = L.featureGroup();

    ...
    map.eachLayer(function(layer){
        if (layer.dragging !== undefined){
          if(layer.dragging._enabled){
            layer.dragging._offset = offset;
            layer.dragging._startPoint = startPoint;
            layer.dragging._path.eachLatLng(layer.dragging.updateLatLng, layer.dragging);
            layer.dragging._path.redraw();
          }
        }
    });

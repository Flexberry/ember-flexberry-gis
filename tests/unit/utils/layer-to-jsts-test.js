...
module('Unit | Utility | layer to jsts', function () {
  ...
  test('test method latlngToPointJsts and geometryToJsts for Point', function (assert) {
    ...
    // Act
    const resultToJsts = latlngToPointJsts(latlng, crs);
    const resultFromGeoJSON = geometryToJsts(feature);
  ...
  test('test method latlngToPointJsts and geometryToJsts for Point with altitude', function (assert) {
    // Arrange
    const latlng = L.latLng(30, 10, 20);
    const feature = {
      type: 'Point',
  ...
  test('test method latlngToPolylineJsts and geometryToJsts for LineString', function (assert) {
    ...
    // Act
    const resultToJsts = latlngToPolylineJsts(latlngs, crs);
    const resultFromGeoJSON = geometryToJsts(feature);
  ...
  test('test method latlngToPolygonJsts and geometryToJsts for Polygon without hole', function (assert) {
    ...
    // Act
    const resultToJsts = latlngToPolygonJsts(latlngs, crs);
    const resultFromGeoJSON = geometryToJsts(feature);
  ...
  test('test method latlngToPointJsts and geometryToJsts for Point', function (assert) {
    // Arrange
    const latlng = L.latLng(30.2412455, 10.0293053246);
    const feature = {
      type: 'Point',
    ...
    // Act
    const resultToJsts = latlngToPointJsts(latlng, crs, false, 10000);
    const resultFromGeoJSON = geometryToJsts(feature, 10000);
  ...
  test('test method latlngToPolylineJsts and geometryToJsts for LineString', function (assert) {
    // Arrange
    const latlngs = [L.latLng(30.2412455, 10.0293053246), L.latLng(10.34325346, 30.43653456), L.latLng(40.45644567, 40.2356236)];
    const feature = {
      type: 'LineString',
    ...
    // Act
    const resultToJsts = latlngToPolylineJsts(latlngs, crs, false, 10000);
    const resultFromGeoJSON = geometryToJsts(feature, 10000);
  ...
  test('test method latlngToPolygonJsts and geometryToJsts with geometry reducer', function (assert) {
    ...
    // Act
    const resultToJsts = latlngToPolygonJsts(latlngs, crs, false, 10000);
    const resultFromGeoJSON = geometryToJsts(feature, 10000);

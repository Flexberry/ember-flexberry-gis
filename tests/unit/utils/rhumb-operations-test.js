...
test('test method createObjectRhumb for Polygon with startPoint in EPSG:4326', function(assert) {
  ...
  let resObj = {
    ...
    geometry: {
      type: 'Polygon',
      coordinates: [
        [[-5936517.120908923, 517670.4443068467], [-5937517.120908923, 517670.4443068467], [-5937517.120908923, 518670.4443068467],
        [-5936517.120908923, 518670.4443068467], [-5936517.120908923, 517670.4443068467]]
      ]
    },
    crs: {
      type: 'name',
...
test('test method createObjectRhumb for LineString with startPoint in EPSG:4326', function(assert) {
  ...
  let resObj = {
    ...
    geometry: {
      ...
      coordinates: [
        [-5936517.120908923, 517670.4443068467], [-5937517.120908923, 517670.4443068467], [-5937517.120908923, 518670.4443068467],
        [-5936517.120908923, 518670.4443068467]
      ]
    },
    crs: {
      type: 'name',

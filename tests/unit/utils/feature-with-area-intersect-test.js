import featureWithAreaIntersect, {
  intersectionArea
} from 'ember-flexberry-gis/utils/feature-with-area-intersect';
import { module, test } from 'qunit';
import sinon from 'sinon';

module('Unit | Utility | intersectionArea', function () {
  const testAObjIntersect = L.polygon([
  ...
  const testBObjIntersect = L.polygon([
  ...
  const testBObjNotIntersect = L.polygon([[5, 5], [6, 7], [7, 6], [5, 5]]).toGeoJSON();
  ...
  test('test method intersectionArea for two polygon', function (assert) {
    ...
    // Act
    const res = intersectionArea(testAObjIntersect, testBObjIntersect, 10000);
  ...
  test('test method intersectionArea for two polygon with scale 0.1', function (assert) {
    ...
    // Act
    const res = intersectionArea(testAObjIntersect, testBObjIntersect, 0.1);
  ...
  test('test method intersectionArea for two polygon with scale 10', function (assert) {
    ...
    // Act
    const res = intersectionArea(testAObjIntersect, testBObjIntersect, 10);
  ...
  test('test method intersectionArea for two polygon not intesect', function (assert) {
    ...
    // Act
    const res = intersectionArea(testAObjIntersect, testBObjNotIntersect, 10000);
  ...
  test('test method featureWithAreaIntersect for two polygon', function (assert) {
    ...
    // Arrange
    const _convertObjectCoordinates = () => testBObjIntersect;
    ...
    // Act
    const res = featureWithAreaIntersect(testAObjIntersect, testBObjIntersect, leafletLayer, mapModel, 10000);
  ...
  test('test method featureWithAreaIntersect for two polygon not intersect', function (assert) {
    ...
    // Arrange
    const _convertObjectCoordinates = () => testBObjNotIntersect;
    ...
    // Act
    const res = featureWithAreaIntersect(testAObjIntersect, testBObjNotIntersect, leafletLayer, mapModel, 10000);

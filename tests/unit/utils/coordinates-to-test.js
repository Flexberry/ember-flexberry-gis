import {
  coordinatesToString,
  coordinatesToArray
} from 'ember-flexberry-gis/utils/coordinates-to';
import { module, test } from 'qunit';

module('Unit | Utility | coordinates to', function () {
  test('test methods coordinatesToString and coordinatesToArray for Point', function (assert) {
    ...
    const resultString = coordinatesToString(feature.coordinates);
    const resultArray = coordinatesToArray(feature.coordinates);

...
module('Unit | Mixin | test method _convertObjectCoordinates', function () {
  ...
  test('test method _convertObjectCoordinates with EPSG:4326', function (assert) {
    ...
    // Act
    const result = subject._convertObjectCoordinates('EPSG:4326', geoJsonObject);
  ...
  test('test method _convertObjectCoordinates with EPSG:3395', function (assert) {
    ...
    // Act
    const result = subject._convertObjectCoordinates('EPSG:4326', geoJsonObject, 'EPSG:3395');

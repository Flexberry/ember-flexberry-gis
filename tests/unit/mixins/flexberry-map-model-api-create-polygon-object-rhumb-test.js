...
module('Unit | Mixin | test method createPolygonObjectRhumb', function () {
  const mapApiMixinObject = EmberObject.extend(FlexberryMapModelApiMixin);
  const crs4326 = crsFactory4326.create();
  ...
  test('test method createPolygonObjectRhumb for LineString', function (assert) {
    ...
    // Act
    const feature = subject.createPolygonObjectRhumb('1', testLiseString);

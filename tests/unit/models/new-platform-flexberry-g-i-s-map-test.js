...
module('Unit | Model | new-platform-flexberry-g-i-s-map', function(hooks) {
  ...
  test('it exists', function(assert) {
    let model = run(() => this.owner.lookup('service:store').createRecord('new-platform-flexberry-g-i-s-map'));

    assert.ok(!!model);
  });

  test('substitution _getModelLayerFeature', function (assert) {
    let map = run(() => this.owner.lookup('service:store').createRecord('new-platform-flexberry-g-i-s-map'));

...
import layout from '../templates/components/flexberry-ddau-slider';
...
/**
  ...
  ```javascript
  import Ember from 'ember';
  import FlexberryDdauSliderActionsHandlerMixin from 'ember-flexberry-gis/mixins/flexberry-ddau-slider-actions-handler';

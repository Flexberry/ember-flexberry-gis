...
import layout from '../templates/components/flexberry-colorpicker';
...
/**
  ...
  ```javascript
  import Ember from 'ember';
  import FlexberryColorpickerActionsHandlerMixin from 'ember-flexberry-gis/mixins/flexberry-colorpicker-actions-handler';

...
export default OfflineGlobals.extend({
  getOfflineSchema() {
    ...
    let returnedSchema = Ember.merge(parentSchema, {
      'new-platform-flexberry-g-i-s-background-layer': 'id,anyText,boundingBox,coordinateReferenceSystem,createTime,creator,description,' +
        'editor,editTime,index,keyWords,name,owner,public,scale,settings,type,visibility',
      'new-platform-flexberry-g-i-s-csw-connection': 'id,createTime,creator,editor,editTime,name,url',
			...
			'new-platform-flexberry-g-i-s-layer-metadata': 'id,additionalData,anyText,boundingBox,coordinateReferenceSystem,createTime,creator,' +
        'description,editor,editTime,keyWords,name,scale,settings,type,*linkMetadata',
			...
			'new-platform-flexberry-g-i-s-map-layer': 'id,anyText,boundingBox,coordinateReferenceSystem,createTime,creator,description,editor,' +
        'editTime,index,keyWords,name,owner,public,scale,securityKey,settings,type,visibility,parent,map,*layerLink',
			'new-platform-flexberry-g-i-s-map-object-setting': 'id,editForm,listForm,multEditForm,title,typeName,defaultMap',
			'new-platform-flexberry-g-i-s-map': 'id,anyText,boundingBox,coordinateReferenceSystem,createTime,creator,description,editor,editTime,' +
        'editTimeMapLayers,keyWords,lat,lng,name,owner,picture,public,scale,settings,zoom,*mapLayer',

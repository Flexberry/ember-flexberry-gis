...
export default RectangleMaptool.extend({
  ...
  */
  _finishIdentification(e) {
    ...
    let propertyNameColumnCaption = i18n.t('maptools.identify.identify-popup.properties-table.property-name-column.caption');
    let propertyValueColumnCaption = i18n.t('maptools.identify.identify-popup.properties-table.property-value-column.caption');
    let layerNameProperty = i18n.t('maptools.identify.identify-popup.properties-table.layer-name-property.caption');
    let layersCountProperty = i18n.t('maptools.identify.identify-popup.properties-table.layers-count-property.caption');
